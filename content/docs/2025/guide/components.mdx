...
<Button href="/docs/2025/guide" variant="solid">시작하기</Button>
```

<Button href="/docs">문서 보기</Button> <Button href="https://github.com">GitHub</Button> <Button href="/docs/2025/guide" variant="solid">시작하기</Button>
